...
internal class LootManagerScript : MonoBehaviour
{
	...
	public void SpawnItem(ItemType itemType)
	{
		...
		{
			ServerEventSystem.Send(10, new object[] { position.x, position.y, position.z, itemType == ItemType.Monster ? 0 : itemType, gameObject.GetComponent<ItemScript>().GameItemID }, false, true, true );
		}
	}
