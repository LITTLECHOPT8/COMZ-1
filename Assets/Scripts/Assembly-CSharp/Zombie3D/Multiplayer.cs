...
namespace Zombie3D
{
	public class Multiplayer : Player
	{
		...
		public Multiplayer(int playerID)
		{
			this.playerID = playerID;
			this.m_multi_id = playerID;
		}
		...
		public void Init()
		{
			...
			playerObject = Players.GetPlayer(playerID);
		...
		{
			ServerEventSystem.Send(13, new object[] { damage } );
		}

		public override void OnVsInjured(PhotonPlayer sender, float damage, int weapon_type)
		{
			if (weapon_type == 10)
			{
