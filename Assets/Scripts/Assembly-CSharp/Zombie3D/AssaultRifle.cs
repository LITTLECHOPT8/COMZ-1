	...
	public class AssaultRifle : Weapon
	{
		...
		public override void Fire(float deltaTime)
		{
			...
			if (raycastHit.collider != null)
			{
				...
				{
					PhotonView view = gameObject2.GetComponent<PhotonView>();
					ServerEventSystem.Send(5, new object[] { view.OwnerActorNr, base.player.Damage, (int)GetWeaponType(), view.transform.position }, true );
				}
				else
				{
					if (vector2.z > 2f)
