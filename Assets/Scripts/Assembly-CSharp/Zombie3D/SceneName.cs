...
namespace Zombie3D
{
    public class SceneName
    {
        ...
        public const int SceneCountPixelVS = 24;
        ...
        public const string SCENE_VILLAGENORMAL = "Zombie3D_Village_Normal";
        ...
        public static string GetMusic(string scene)
        {
            switch (scene)
            {
                case "Zombie3D_Hospital":
                ...
                default:
                    return UnityEngine.Random.Range(0, 2) == 0 ? "BettleMusic" : "backgroundMusic";
            }
        }
        ...
        public static int GetNetMapIndex(string scene)
        {
            switch (scene)
            {
                ...
                case "Zombie3D_FunFair":  // Add your new map here
                    return 23;
                case "Zombie3D_Village_Normal":  // Add your new map here
                    return 24;
                default:
                    return 0;
            }
        ...
        public static string GetNetMapName(int index)
        {
            ...
            switch (index)
            {
                ...
                case 19:
                    ...
                    break;
                case 20:  // Add your new map here
                    result = "Zombie3D_Test";  // Change this to your new map's name
                    break;
                ...
                case 23:  // Add your new map here
                    ...
                    break;
                case 24:  // Add your new map here
                    result = "Zombie3D_Village_Normal";  // Change this to your new map's name
                    break;
            }
            return result;
        }
        ...
        public static string GetTrueMapName(string map)
        {
            switch (map)
            {
                ...
                case "Zombie3D_Rock4":
                    return "DustWorld";
                case "Zombie3D_Test":  // Add your new map case here
                ...
                case "Zombie3D_Village_Normal":  // Add your new map case here
                    return "Dark Residental Area";  // Replace with the actual name you'd like to display
                default:
                    return string.Empty;
            }
        }
