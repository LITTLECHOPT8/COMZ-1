...
namespace Zombie3D
{
	public class GameApp
	{
		...
		protected string path
		{
			get
			{
				return Application.persistentDataPath + (Application.isEditor ? "/editor/" : "/");
			}
		}
		...
		public void PlayerPrefsSave()
		{
			...
			empty = "Nick_Name" + (Application.isEditor ? "_Editor" : "");
		...
		public void PlayerPrefsLoad()
		{
			...
			if (PlayerPrefs.HasKey("Nick_Name" + (Application.isEditor ? "_Editor" : "")))
			{
				GetInstance().GetGameState().nick_name = PlayerPrefs.GetString("Nick_Name" + (Application.isEditor ? "_Editor" : ""));
			}
			else
			{
				GetInstance().GetGameState().nick_name = "None";
				PlayerPrefs.SetString("Nick_Name" + (Application.isEditor ? "_Editor" : ""), "None");
			}
