		...
		public override void Fire(float deltaTime)
		{
			...
			else
			{
				...
				foreach (Player value2 in gameVSScene.SFS_Player_Arr.Values)
				{
					...
					{
						ServerEventSystem.Send(5, new object[] { value2.PlayerObject.GetComponent<PhotonView>().OwnerActorNr, player.Damage, (int)GetWeaponType(), value2.GetTransform().position }, true );
					}
