...
public class TPSSimpleCameraScript : BaseCameraScript
{
	...
	private void Start()
	{
		...
		base.GetComponent<Camera>().GetComponent<AudioSource>().clip = Resources.Load<AudioClip>("music/" + SceneName.GetMusic(Application.loadedLevelName));//gameObject.GetComponent<BettleMusicScript>().BettleAudio;
