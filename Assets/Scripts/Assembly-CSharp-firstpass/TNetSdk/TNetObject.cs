...
namespace TNetSdk
{
	public class TNetObject : TDispatchable
	{
		...
		private PunCallback _callback;

		private PunCallback punCallback
		{
			get
			{
				if (_callback == null)
				{
					_callback = PunCallback.CreateCallback();
				}
				return _callback;
			}
		}
		...
		public void SetOnConnect(PunCallback.Connect onConnection)
		{
			punCallback.connect = onConnection;
		}

		public void SetOnDisconnect(PunCallback.Disconnect onDisconnect)
		{
			punCallback.disconnect = onDisconnect;
		}

		public void SetOnJoinedRoom(PunCallback.JoinRoom onJoinRoom)
		{
			punCallback.join_room = onJoinRoom;
		}

		public void SetOnLeftRoom(PunCallback.LeftRoom onLeftRoom)
		{
			punCallback.left_room = onLeftRoom;
		}

		public void SetOnConnectedToMaster(PunCallback.ConnectedToMaster onConnectedToMaster)
		{
			punCallback.connected_to_master = onConnectedToMaster;
		}

		public void SetOnPlayerJoined(PunCallback.PlayerJoined onPlayerJoin)
		{
			punCallback.player_joined = onPlayerJoin;
		}

		public void SetOnPlayerLeft(PunCallback.PlayerLeft onPlayerLeft)
		{
			punCallback.player_left = onPlayerLeft;
		}

		public void SetOnPlayerPropsChanged(PunCallback.PlayerPropertiesChanged onPlayerPropsChanged)
		{
			punCallback.player_props_changed = onPlayerPropsChanged;
		}

		public void SetOnRoomPropsChanged(PunCallback.RoomPropertiesChanged onRoomPropsChanged)
		{
			punCallback.room_props_changed = onRoomPropsChanged;
		}

		public void SetOnServerEvent(PunCallback.ServerEvent onServerEvent)
		{
			punCallback.server_event = onServerEvent;
		}

		public void RemoveCallbacks()
		{
			punCallback.connect = null;
			punCallback.disconnect = null;
			punCallback.join_room = null;
			punCallback.player_joined = null;
			punCallback.player_left = null;
			punCallback.player_props_changed = null;
			punCallback.room_props_changed = null;
			punCallback.server_event = null;
		}
		...
		public void Connect()
		{
			PhotonNetwork.ConnectUsingSettings("4.6");
		}
